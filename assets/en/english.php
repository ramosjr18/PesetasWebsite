...
<body>
        ...
        <div class="contentwill">
            <div class="nav">
                <nav>
                    <div class="idioma">
                        <ul>
                            <li><a href="./english.php"><img src="../img/reino-unido.png" alt="">
                                    <ul>
                                        <li><a href="../es/espanol.php"><img src="../img/espana.png" alt=""></a></li>
                    ...
                    <div class="list_nav">
                        <ul>
                            ...
                            <li><a href="#Lage">Location</a></li>
                            <li><a href="#Bilder">Photos</a></li>
                            <li><a href="#Reservierung">Reservations</a></li>
                        </ul>
                    </div>
                    <div class="login">
                        <ul>
            ...
            <h1>Welcome to Pesetas</h1>

            <div class="logo">
                <img src="..\img\logodepesetas.png" alt="Logo de Pesetas" width="30%" />
            </div>
    ...
    <div class="about">
        ...
        <div class="textoabout">
            <h1> What can be found in Pesetas?</h1>

            <p>Experience the authentic taste and have a wonderful time in our lovingly furnished restaurant. <br><br>
                Enjoy our traditionally prepared paella or small tapas with our full-bodied Spanish wines, traditionally prepared sangria, or an ice-cold beer.
            </p>
            <br>
            <p>
                You can also order delicious things from the Pesetas kitchen to pick up from Monday to Saturday from 17:00 to "Open End".
            </p>
            <br>
            <p>
                All other news or current information can always be found on our social media.
            </p>
            <br>
            <p>
                ¡Hasta pronto!
    ...
    <div class="formular" id="Reservierung">
        <div class="formtext">
            ...
            <br>
            <h2>Opening</h2>
            <p>Mo - Sa from 17:00 until "Open End"</p>
        </div>
        <div class="form">
            <form action="../../php/reservations.php" method="post">
                ...
                <br> <br>
                <textarea name="notes" id="" cols="47" rows="10" placeholder="Comments"></textarea>
                <br>
                <button type="submit" , class="button type4"> Reserve</button>
            </form>
        </div>
    </div>
    <br>
